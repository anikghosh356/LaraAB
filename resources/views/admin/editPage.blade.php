...
@section('content') 
  ...
  <form class="row" style=" margin-bottom: 20px;" method="post" action="{{ route('admin.pageUpdate', $page->id) }}" enctype="multipart/form-data">
    @csrf
  	<div class="col-md-8">
  		<div class="form-group">
			<label for="page_name">Page Name</label>
		    <input type="text" class="form-control" id="page_name" aria-describedby="emailHelp" placeholder="Page Name " name="page_name" value="{{ $page->page_name }}">
		</div>
		<div class="form-group">
