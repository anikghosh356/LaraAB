...
@section('content') 
  ...
  <div class="row container" style="margin-bottom: 20px;">
    <form class="col-md-12" method="post" action="{{ route('admin.categories') }}">
      @csrf
      <div class="row ">
        <div class="form-group col-md-8">
          <input type="text" class="form-control form-control-user @error('cat_name') is-invalid @enderror"  placeholder="Enter Category Name.." value="{{ old('cat_name') }}" name="cat_name">
        </div>
