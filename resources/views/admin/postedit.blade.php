...
@section('content') 
  ...
  <form class="row" style=" margin-bottom: 20px;" method="post" action="{{ route('admin.update', $post->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="col-md-8">
      <div class="form-group">
      <label for="post_title">Post Title</label>
        <input type="text" class="form-control" id="post_title" aria-describedby="emailHelp" placeholder="Post Title" name="post_title" value="{{ $post->post_title }}">
    </div>
    <div class="form-group">
    ...
    <div class="col-md-4" style="overflow: hidden;margin-top: 30px;margin-bottom: 30px;">
      <div class="row">
        ...
        <select class="custom-select" id="category" name="post_category">
          ...
          <option value="{{ $category->id }}" <?php echo ($category->id == $post->category_id) ? "selected" : false; ?> >{{ $category->category_name }}</option>
          @endforeach
        </select>
      ...
      <div class="row" style="margin-top: 10px;">
        <div class="input-group col-md-11">
            ...
            <input type="text" data-role="tagsinput"  id="tags" style="display: none;" name="tags" value="{{ $post->tags }}">
        </div>
      ...
      <div class="row" style="margin:10px auto;">
        ...
        <div class="col-md-12">
          <img src="{{ asset('img/temp/'.$post->post_thumbnail) }}" id="thumbpre" style="width: 100%; max-height: 500px; overflow: hidden;">
        </div>
      </div>
